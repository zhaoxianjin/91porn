...
public class DownloadService extends Service {
    ...
    private void updateNotification(BaseDownloadTask task, int soFarBytes, int totalBytes, int action) {
        ...
        String fileSize = Formatter.formatFileSize(DownloadService.this, soFarBytes).replace("MB", "") + "/ " + Formatter.formatFileSize(DownloadService.this, totalBytes);
    ...
    private void startNotification(int action, int progress, String fileSize, int speed) {
        ...
        Intent pauseStartIntent = new Intent(this, DownloadService.class);
