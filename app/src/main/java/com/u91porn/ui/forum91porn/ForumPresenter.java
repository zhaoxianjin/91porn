package com.u91porn.ui.forum91porn;
...
import com.u91porn.parse.ParseForum91Porn;
...
public class ForumPresenter extends MvpBasePresenter<ForumView> implements IForum {
    ...
    public ForumPresenter(Forum91PronServiceApi forum91PronServiceApi, LifecycleProvider<FragmentEvent> provider) {
    ...
    public void loadForumIndexListData(final boolean pullToRefresh) {
        forum91PronServiceApi.index()
                ...
                .compose(provider.<List<PinnedHeaderEntity<Forum91PronItem>>>bindUntilEvent(FragmentEvent.DESTROY))
    ...
    public void loadForumListData(final boolean pullToRefresh, String fid) {
        ...
        forum91PronServiceApi.forumdisplay(fid, page)
                ...
                .compose(provider.<List<Forum91PronItem>>bindUntilEvent(FragmentEvent.DESTROY))
