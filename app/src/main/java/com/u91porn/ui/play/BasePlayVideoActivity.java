 ...
 * @author flymegoc
 */
public abstract class BasePlayVideoActivity extends MvpActivity<PlayVideoView, PlayVideoPresenter> implements PlayVideoView {

    private final String TAG = BasePlayVideoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoplayerContainer.addView(getPlayerView());
    ...
    private void initData() {
        ...
        if (tmp == null || tmp.getVideoResult().getTarget() == null || TextUtils.isEmpty(tmp.getVideoResult().getTarget().getVideoUrl()) || TextUtils.isEmpty(tmp.getVideoResult().getTarget().getOwnnerName())) {
            ...
            //加载评论
            presenter.loadVideoComment(tmp.getVideoResult().getTarget().getVideoId(), false, HeaderUtils.getPlayVideoReferer(unLimit91PornItem.getViewKey()));
        }
    }
    ...
    private void setLoadingViewVideoCommentHeight() {
        ...
        appBarLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                int screenHeight = QMUIDisplayHelper.getScreenHeight(BasePlayVideoActivity.this);
                int remainHeight = screenHeight - height;
                if (remainHeight != height) {
                    SPUtils.put(BasePlayVideoActivity.this, Keys.KEY_SP_APPBARLAYOUT_HEIGHT, remainHeight);
    ...
    public void playVideo(VideoResult videoResult) {
        ...
        presenter.loadVideoComment(videoResult.getVideoId(), false, HeaderUtils.getPlayVideoReferer(unLimit91PornItem.getViewKey()));
