...
public class PlayVideoActivity extends MvpActivity<PlayVideoView, PlayVideoPresenter> implements PlayVideoView {
    ...
    private void initListener() {
        ...
        commentSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                presenter.loadVideoComment(videoId, true);
            }
        });
    ...
    private void commentOrReplyVideo(String comment) {
        ...
        if (isComment) {
            ...
            presenter.commentVideo(comment, uid, vid);
        } else {
            ...
            presenter.replyComment(comment, username, vid, commentId);
        }
    }
    ...
    private void initData() {
        ...
        if (tmp == null || tmp.getVideoResult().getTarget() == null || TextUtils.isEmpty(tmp.getVideoResult().getTarget().getOwnnerName())) {
            ...
            //加载评论
            presenter.loadVideoComment(tmp.getVideoResult().getTarget().getVideoId(), false);
        }
    }

    private void setToolBarLayoutInfo(UnLimit91PornItem unLimit91PornItem) {
        tvPlayVideoTitle.setText(unLimit91PornItem.getTitle());
        VideoResult videoResult = unLimit91PornItem.getVideoResult().getTarget();
        tvPlayVideoAuthor.setText("作者：" + videoResult.getOwnnerName());
        ...
        helper.setListener(new OnLoadViewListener() {
            ...
            public void onRetryClick() {
                if (isVideoError) {
                    ...
                    //加载评论
                    presenter.loadVideoComment(unLimit91PornItem.getVideoResult().getTarget().getVideoId(), false);
                }
            }
        });
    }
    ...
    private void setLoadingViewVideoCommentHeight() {
        ...
        appBarLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                int screenHeight = QMUIDisplayHelper.getScreenHeight(PlayVideoActivity.this);
                int remainHeight = screenHeight - height;
                if (remainHeight != height) {
                    SPUtils.put(PlayVideoActivity.this, Keys.KEY_SP_APPBARLAYOUT_HEIGHT, remainHeight);
    ...
    public void playVideo(VideoResult videoResult) {
        ...
        presenter.loadVideoComment(videoResult.getVideoId(), false);
    ...
    private void goToLogin() {
        Intent intent = new Intent(PlayVideoActivity.this, UserLoginActivity.class);
