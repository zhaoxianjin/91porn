...
public class Keys {
    ...
    public final static String KEY_SP_DOWNLOAD_VIDEO_NEED_WIFI = "key_sp_download_video_need_wifi";
    ...
    public final static String KEY_SP_PROXY_IP_ADDRESS = "key_sp_proxy_ip_address";
    public final static String KEY_SP_PROXY_PORT = "key_sp_proxy_port";
    public final static String KEY_INTENT_LOGIN_FOR_ACTION = "key_intent_login_for_action";
    public final static String KEY_SP_NEVER_ASK_FOR_WATCH_DOWNLOAD_TIP = "key_sp_never_ask_for_watch_download_tip";
    public final static String KEY_SP_IGNORE_THIS_VERSION_UPDATE_TIP = "key_sp_ignore_this_version_update_tip";
    public final static String KEY_SP_FORBIDDEN_AUTO_RELEASE_MEMORY_WHEN_LOW_MEMORY = "key_sp_forbidden_auto_release_memory_when_low_memory";
